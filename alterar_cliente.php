...
input, select{width:300px;padding:5px;margin-top:2px}
...
Sobrenome: <input type="text" name="sobrenome" value="<?php echo htmlspecialchars($cliente['sobrenome']); ?>" required><br>
Gênero:
<label for="genero">Selecione seu gênero:</label>
<select name="genero" id="genero" required>
<?php
$generos = [
    "homem","mulher","transmasculino","transfeminino","naobinario","agenero","bigenero","pangenero",
    "demiboy","demigirl","genderfluid","genderqueer","androgino","neutrois","two-spirit","intergenero",
    "poligenero","maverique","omnigenero","x-gender","genderquestioning","gendernonconforming","gendervariant",
    "androgyne","demiflux","autigenero","ceterogenero","greygender","neutro-gênero","floragenero",
    "libragenero","novigenero","mirigenero","quarternario","omnisexual-gender","androsexual-gender",
    "gynesexual-gender","skoliosexual-gender","demigender","subgender","novogender","transgenero",
    "cisgenero","androqueer","gyniqueer","apogenero","ambigenero","exogenero","outra"
];
...
Nascimento: <input type="date" name="nascimento" value="<?php echo htmlspecialchars($cliente['nascimento']); ?>" required><br>
Fone: <input type="text" name="fone" value="<?php echo htmlspecialchars($cliente['fone']); ?>"><br>
Logradouro: <input type="text" name="longadouro" value="<?php echo htmlspecialchars($cliente['longadouro']); ?>"><br>
Número: <input type="text" name="numero" value="<?php echo htmlspecialchars($cliente['numero']); ?>"><br>
Complemento: <input type="text" name="complemento" value="<?php echo htmlspecialchars($cliente['complemento']); ?>"><br>
